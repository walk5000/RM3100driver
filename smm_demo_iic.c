...
/* An interface for the RM3100 3-axis magnetometer SMMode */
int RM3100_SMM_Test(void *self)
{
    ...
    printf("### Hello RM3100 i2c smm sample ###\r\n");
